...
// manda id/earned/progress/target, igual o padrão já usado em
// STATUS_LABEL_KEYS pra status de biblioteca.
const ACHIEVEMENT_META: Record<string, { icon: string; nameKey: string; descriptionKey: string }> = {
