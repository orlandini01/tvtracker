...
async def search_media(
    ...
    return await _call(tmdb.search(query, page))
...
async def discover_media(
    ...
    return await _call(tmdb.discover(category, page))
...
async def media_detail(
    ...
    return await _call(tmdb.get_detail(media_type, tmdb_id))
...
async def media_watch_providers(
    ...
    return await _call(tmdb.get_watch_providers(media_type, tmdb_id, region))
